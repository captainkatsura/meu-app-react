...
import moviePic from '../assets/images/mandalorian.jpg';

function ContentRowTopComponent() {
						...
						<div className="card shadow mb-4">
							...
							<div className="card-body">
								<div className="text-center">
									<img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "40rem"}} src={moviePic} alt=" Star Wars - Mandalorian " />
								</div>
...
export default ContentRowTopComponent;